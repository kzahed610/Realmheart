...
std::optional<RelictombsSelection> RelictombsSelection::create(
...
const std::filesystem::path& RelictombsSelection::selected() const noexcept {
    static const std::filesystem::path empty;
    if (candidates_.empty()) return empty;
    return candidates_[selected_index_ % candidates_.size()];
}

RelictombsPreviewSet RelictombsSelection::preview() const {
    RelictombsPreviewSet result;
...
std::size_t RelictombsSelection::candidate_count() const noexcept {
    return candidates_.size();
}

std::size_t RelictombsSelection::selected_index() const noexcept {
    return selected_index_;
}

bool RelictombsSelection::navigate(int direction) noexcept {
