...
struct RelictombsPreviewSet {
    // Relictombs currently renders previous_far as the tiny top chamber, then
...
// Pure selection model for Relictombs. It owns no textures and performs no I/O;
...
class RelictombsSelection {
public:
    [[nodiscard]] static std::optional<RelictombsSelection> create(
    ...
    [[nodiscard]] RelictombsPreviewSet preview() const;
