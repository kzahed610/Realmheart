...
void parses_supported_shell_commands() {
    ...
    require(parse_shell_command("mana-cores-toggle") == ShellCommand::ToggleManaCores,
            "mana-cores-toggle should parse");
...
void maps_commands_to_stable_action_names() {
    ...
    require(shell_action_name(ShellCommand::ToggleManaCores) == "mana-cores-toggle",
            "ManaCores action name should be stable");
...
void identifies_commands_that_require_arguments() {
    ...
    require(!shell_command_requires_argument(ShellCommand::ToggleManaCores),
            "ManaCores toggle should remain parameterless");
