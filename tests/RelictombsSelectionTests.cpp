...
TEST(RelictombsSelectionTests, ExcludesCommittedWallpaperAndStartsAfterIt) {
    ...
    const auto selection = RelictombsSelection::create(library, "/walls/b.jpg");
...
TEST(RelictombsSelectionTests, FiveCandidatesExposeInvisibleFarNeighbours) {
    const std::vector<std::filesystem::path> library{
        "/walls/current.jpg",
        "/walls/a.jpg",
        "/walls/b.jpg",
    ...
    const auto selection = RelictombsSelection::create(
        library,
        "/walls/current.jpg"
    );
    ASSERT_TRUE(selection.has_value());
...
TEST(RelictombsSelectionTests, NavigationWrapsBothDirections) {
    const std::vector<std::filesystem::path> library{
        "/walls/a.jpg",
        "/walls/b.jpg",
        "/walls/c.jpg",
    ...
    auto selection = RelictombsSelection::create(library, "/walls/a.jpg");
    ASSERT_TRUE(selection.has_value());
...
TEST(RelictombsSelectionTests, TwoCandidatesShowOneDistinctNeighbour) {
    const std::vector<std::filesystem::path> library{
        "/walls/current.jpg",
        "/walls/a.jpg",
        "/walls/b.jpg",
...
TEST(RelictombsSelectionTests, OneImageLibraryRemainsSafe) {
    const std::vector<std::filesystem::path> library{
        "/walls/only.jpg",
    };
    auto selection = RelictombsSelection::create(library, "/walls/only.jpg");
    ASSERT_TRUE(selection.has_value());
